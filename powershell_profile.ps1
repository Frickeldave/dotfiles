...
$global:_profile_logging = "{0}\powershell_profile_logging.ps1" -f "$global:_profile_script_root"
...
Write-Output "Profile: Import logging functions"
. $global:_profile_logging